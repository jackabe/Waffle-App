...
public class MainActivity extends AppCompatActivity implements OnCompleteListener<Void> {
    ...
    private enum PendingGeofenceTask { // Tracks whether the user requested to add or remove geofences, or to do neither.
        ADD, REMOVE, NONE
    }
    ...
    private void createLocationCallback() {
        mLocationCallback = new LocationCallback() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                ...
                Log.i("Success", Double.toString(mCurrentLocation.getLatitude()));
                Log.i("Success", Double.toString(mCurrentLocation.getLongitude()));
                Log.i("Success", Double.toString(mCurrentLocation.getAccuracy()));
            }
        };
    }
